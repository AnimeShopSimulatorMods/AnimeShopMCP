using AnimeShopBridge.Net;
using MelonLoader;
using UnityEngine;

[assembly: MelonInfo(typeof(AnimeShopBridge.Main), AnimeShopBridge.ModInfo.Name, AnimeShopBridge.ModInfo.Version, AnimeShopBridge.ModInfo.Author, AnimeShopBridge.ModInfo.DownloadLink)]
[assembly: MelonColor(255, 160, 160, 160)]
[assembly: MelonAuthorColor(255, 120, 200, 255)]

namespace AnimeShopBridge
{
    public static class ModInfo
    {
        public const string Name = "Anime Shop Bridge";
        public const string Version = "0.1.0";
        public const string Author = "1REDfriend";
        public const string DownloadLink = null;
        public const string Description =
            "Dev-only: lets the Anime Shop MCP server inspect and drive the running game. Never ship to players.";
    }
    ...
    public class Main : MelonMod
    {
        ...
        {
            var category = MelonPreferences.CreateCategory("AnimeShopBridge", ModInfo.Name);
            ...
            {
                MelonLogger.Error($"[AnimeShopBridge] Could not listen on port {_port.Value}: {ex.Message}");
            }
        }
